...
export function AdvisorEarnings({ earnings, payouts = [] }) {
            ...
            <div className="space-y-2">
              ...
              <div className="space-y-2">
                {payouts.slice(0, 5).map((payout) => (
                  <div
                    key={payout.id}
                    className="flex items-center justify-between p-3 rounded-md bg-muted/10 border border-cyan-900/10"
                  >
                    <div>
                      <p className="text-white font-medium">
        ...
        <DialogContent>
          ...
          <form onSubmit={handlePayoutRequest} className="space-y-4">
            <div className="bg-muted/20 p-4 rounded-lg space-y-2">
              ...
              <div className="border-t border-cyan-900/20 pt-2 flex justify-between font-medium">
