...
import { setAvailabilitySlots } from "@/actions/advisor";
  ...
  return (
    <Card className="border-cyan-900/20">
      <CardHeader>
        ...
        <CardDescription>
          Set your daily availability for founder appointments
        </CardDescription>
      </CardHeader>
      <CardContent>
        ...
        {!showForm ? (
              ...
              {slots.length === 0 ? (
                ...
                <div className="space-y-3">
                  {slots.map((slot) => (
                    <div
                      key={slot.id}
                      className="flex items-center p-3 rounded-md bg-muted/20 border border-cyan-900/20"
                    >
                      <div className="bg-cyan-900/20 p-2 rounded-full mr-3">
          ...
          <form
            ...
            className="space-y-4 border border-cyan-900/20 rounded-md p-4"
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-background border-cyan-900/20"
                />
                {errors.startTime && (
        ...
        <div className="mt-6 p-4 bg-muted/10 border border-cyan-900/10 rounded-md">
          <h4 className="font-medium text-white mb-2 flex items-center">
            <AlertCircle className="h-4 w-4 mr-2 text-cyan-300" />
            How Availability Works
          </h4>
          <p className="text-muted-foreground text-sm">
            Setting your daily availability allows founders to book appointments
